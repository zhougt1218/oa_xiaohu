...
public class AliyunMessageUtil {
    ...
    private static final String accessKeyId = "LTAIi9ZMOv2k6DoO";
    private static final String accessKeySecret = "PuXb09UYoPgg2nLWeGeoSGyO1dTcQF";
    ...
    public static SendSmsResponse sendSms(Map<String, String> paramMap) throws com.aliyuncs.exceptions.ClientException {
        ...
        System.setProperty("sun.net.client.defaultReadTimeout", "4  000");
...
//        request.setOutId(paramMap.get("outId"));
   ...
   /* public String sendMsg() throws LgdServiceException, ClientException {
        ...
        String phoneNumber = "18615402286";
        String randomNum = createRandomNum(6);
        String jsonContent = "{\"number\":\"" + randomNum + "\"}";

        Map<String, String> paramMap = new HashMap<>();
        paramMap.put("phoneNumber", phoneNumber);
        paramMap.put("msgSign", "开拓者2018");
        paramMap.put("templateCode", "SMS_143560650");
